...
const FAQS = [
  {
    ...
    a: "Completamente seguro. Solo pagas cuando el paquete está en tus manos. No pedimos tarjeta. No pedimos depósito. Te llamamos desde CDMX para confirmar antes de enviar. Tu tranquilidad es lo primero. Siempre.",
  },
  {
    q: "¿Cuánto tarda el envío?",
    a: "3 a 5 días hábiles en CDMX, Guadalajara, Monterrey, Puebla, Querétaro. 5 a 7 días para el resto del país. Siempre gratis. Y te llamamos para confirmar antes de que salga tu paquete. Nunca quedas en la oscuridad.",
  },
  {
  ...
  {
    q: "¿Tienen soporte en México?",
    a: "Sí. Nuestro equipo llama desde números locales de CDMX. Confirmamos por teléfono. Respondemos rápido por correo. No somos una empresa fantasma. Somos gente real que usa Brisa, Guardián y Mariposa todos los días. Si algo falla, hablas con nosotros. No con un bot.",
  },
  {
    q: "¿Por qué comprar en Vazlina y no en Amazon?",
    a: "Amazon vende de todo. Nosotros solo vendemos lo que nosotros usaríamos. Probamos 18 protectores para elegir a Guardián. 15 audífonos para elegir a Mariposa. Cada producto pasa por pruebas reales en México: en veranos de 40°, en noches de ansiedad, en salidas donde queremos sentirnos bien. Y si algo falla, hablas con nosotros. No con un bot.",
  },
  {
