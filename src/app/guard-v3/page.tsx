  ...
  return (
    <div className="font-body" style={{ backgroundColor: BG }}>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 py-2 px-3 text-center" style={{ backgroundColor: ORANGE }}>
        <p className="text-xs font-bold tracking-widest uppercase mb-1" style={{ color: "rgba(255,255,255,0.95)" }}>&#161;Precio especial por tiempo limitado!</p>
        <p className="text-white text-sm font-bold flex flex-row items-center justify-center gap-2 flex-wrap leading-none">
          <span className="pulse inline-flex items-center gap-1">
            ...
            <span className="tabular-nums font-mono bg-black/20 px-1.5 py-0.5 rounded text-sm">{timer}</span>
          </span>
          <span className="opacity-40">|</span>
          <span><s className="opacity-60">&#8353;22,500</s> &#8250; <strong>&#8353;17,700 HOY</strong></span>
        </p>
        <p className="text-xs font-semibold mt-1" style={{ color: "rgba(255,255,255,0.9)" }}>Paga contra entrega &#183; Env&#237;o gratis a todo CR</p>
      </div>
      ...
      <section className="pt-20 pb-14" style={{ backgroundColor: WHITE }}>
        <div className="max-w-lg mx-auto px-5">
          ...
          <div className="lp-animate flex justify-center mb-4">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-bold" style={{ backgroundColor: "#FFE8D0", border: "1px solid #FFB870", color: ORANGE }}>
