      ...
      <section className="pt-24 pb-14" style={{ backgroundColor: WHITE }}>
        <div className="max-w-lg mx-auto px-5">
          ...
          <div className="lp-animate flex justify-center mb-4">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-bold" style={{ backgroundColor: "#EFF6FF", border: "1px solid #BFDBFE", color: "#1D4ED8" }}>
